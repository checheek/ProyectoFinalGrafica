...
void animate(void)
{
	lightPosition.x = 300.0f * cos(myValue);
	lightPosition.z = 300.0f * sin(myValue);
	myValue += 0.08f;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		staticShader.setVec3("dirLight.ambient", glm::vec3(0.0f, 0.0f, 0.0f));//Se manejan en valores de 0 y 1 en escala RGB
		staticShader.setVec3("dirLight.diffuse", glm::vec3(ControlColor, ControlColor, ControlColor));
		staticShader.setVec3("dirLight.specular", glm::vec3(0.0f, 0.0f, 0.0f));

		staticShader.setVec3("pointLight[0].position", lightPosition);
		staticShader.setVec3("pointLight[0].ambient", glm::vec3(0.0f, 0.0f, 0.0f));
		staticShader.setVec3("pointLight[0].diffuse", glm::vec3(myColorX,myColorY,myColorZ));
		...
		staticShader.setVec3("pointLight[1].diffuse", glm::vec3(myColorX, myColorY, myColorZ));
